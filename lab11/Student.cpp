...
Student::Student(string pesel, string imie, string nazwisko, string indeks, string rok, string adres, bool* wskaznik)
{
...
bool Student::PodajImie(string imie)
{
...
bool Student::PodajNazwisko(string nazwisko)
{
...
bool Student::PodajPesel(string pesel)
{
...
void Student::PodajAdres(string adres)
{
    if (adres == " ")
        adres = "Nie podano adresu";
    this->adres = adres;
};
bool Student::PodajIndeks(string indeks)
{
...
bool Student::PodajRok(string rok)
{
...
string Student::WyswietlStudenta()
{
    stringstream ss;
    int zmienna;
    string rokz;
...
bool Student::SprawdzDzien(int dzien, int miesiac)
{
    if (dzien > 0)
        switch (miesiac) {
        case 1: {
